...
const FAQS = [
  {
    q: "What is GoldMatch?",
    a: "GoldMatch is a curated marketplace that connects patients specifically looking for gold dental restorations (crowns, bridges, inlays, onlays) with dentists who offer them. We solve the painful search problem — most directories don't filter for gold work, and patients waste hours calling around.",
  },
  {
  ...
  {
    q: "Is GoldMatch available in my area?",
    a: "GoldMatch is available nationwide across the United States. Patients can search by city, state, or ZIP code to find dentists near them.",
  },
];
      ...
      <section className="bg-gradient-to-br from-amber-50 via-white to-amber-50">
        <div className="mx-auto max-w-4xl px-6 py-20 text-center">
          ...
          <p className="mt-6 text-lg leading-relaxed text-gray-600 max-w-2xl mx-auto">
            GoldMatch sends qualified, motivated leads directly to your practice.
      ...
      <section className="bg-white py-20">
        <div className="mx-auto max-w-4xl px-6">
          <h2 className="text-center text-3xl font-bold text-gray-900">
            Why List on GoldMatch?
          </h2>
          <p className="mt-4 text-center text-gray-600">
            Gold dentistry is a niche — but the patients looking for it are
            highly motivated. Here's why joining GoldMatch is worth it.
          </p>
          <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {[
              {
                title: "Qualified Leads",
                desc: "Every patient on GoldMatch is specifically looking for gold restorations. No tire-kickers — just people ready to book.",
                icon: "🎯",
              },
              {
        ...
        <div className="mx-auto max-w-4xl px-6">
          ...
          <div className="mt-16 rounded-2xl bg-amber-50 border border-amber-200 p-8 text-center">
            ...
            <p className="mt-3 text-gray-600">
              Join GoldMatch today. $49 one-time fee. No commissions, no
              monthly charges.
            </p>
            <Link
              to="/register/dentist"
