...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Gold Dentistry Network — Find Gold Dentistry Near You" },
      {
        name: "description",
        content:
          "Gold Dentistry Network connects patients seeking gold crowns, bridges, inlays, and onlays with dentists who specialize in gold restorations.",
      },
    ],
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Bangers&family=Inter:wght@400;500;600;700&family=Outfit:wght@400;500;600;700;800&display=swap",
      },
    ],
  }),
  notFoundComponent: () => (
